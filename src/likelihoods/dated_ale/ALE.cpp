...
void approx_posterior::construct(string tree_string)
{
  ...
  if ( tree_string.substr(0,1) !="(")
    ...
    {
      //todobenoit
      tree_type * tree = 0;//TreeTemplateTools::parenthesisToTree(tree_string,false);//del-loc
...
map < boost::dynamic_bitset<> ,scalar_type > approx_posterior::recompose(string G_string) const
{
  ...
  //todobenoit
  tree_type * G = 0;// TreeTemplateTools::parenthesisToTree(G_string,false);//del-loc
