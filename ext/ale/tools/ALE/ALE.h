...
typedef bpp::PhyloTree tree_type;
typedef long double scalar_type;
typedef std::pair<std::shared_ptr<bpp::PhyloNode>, std::shared_ptr<bpp::PhyloNode>> dedge_type;
...
public:
  //must load
  /// Number of trees observed to build the approx_posterior object.
  scalar_type observations;


  //no need to load
  /// std::string representing the tree in Newick format
  ...
  //no need to load
  /// del-loc. Set containing all leaf ids. ~Clade of all leaves in the tree.
  std::set<int> Gamma_s;                                                             //del-loc. Set containing all leaf ids. ~Clade of all leaves in the tree.
  /// bit vector with all bits to 1 (all species present).
  ...
  /// del-loc. Map between tree string and string containing all bipartitions in the tree.
  ...
  /// del-loc. Dual from above. Map between string containing all bipartitions in the tree and tree string.
  ...
  /// del-loc. Map between a bipartition id and the sizes of the corresponding leaf set.
  std::map <long int,int> set_sizes;                                                 //del-loc. Map between a bipartition id and the sizes of the corresponding leaf set.
  /// del-loc. Map between bipartition size, and the ids of all bipartitions of this size.
  ...
  /// del-loc. Contains the frequency of triplets: mother clade and its two daughter clades. Map between the bipartition id of the mother clade and another map containing a set of bipartition ids (couldn't it be just a pair, in the case of bifurcating trees?) and the frequency of the associated triplet of bipartitions.
  ...
  /// del-loc. Map between a bit vector of leaf ids and the corresponding bipartition index.
  ...
  //numeric
  /// Returns the total number of binary tree topologies possible given a fixed bipartition between n2 leaves on one side and Gamma_size-n2 leaves on the other side.
  ...
  /// Returns the total number of binary tree topologies possible given a fixed trifurcation between n2 leaves in one clade, n3 in another, and Gamma_size-n2-n3 leaves in the last one.
  ...
  /// Probability of a trifurcation given by the ids of the clades.
  ...
  /// Probability of a trifurcation given by the leaf sets of the clades.
  ...
  /// Probability of a bipartition given by its id. Uses the correction term alpha.
  ...
  /// Probability of a bipartition given by its leaf set.
  scalar_type p_bip(boost::dynamic_bitset<> gamma) const;                                  //Probability of a bipartition given by its leaf set.


  //nuisance
  /// Prints the leaf names of leaves contained in a leaf set.
  ...
  ///del-loc. Builds all rooted trees that can be built with leaf set gamma.
  ...
  /// Counts trees that can be amalgamated with the approx_posterior object with the complete leaf set, without actually building these trees.
  ...
  /// Counts trees that can be amalgamated with the leaf set with id g_id, without actually building these trees.
  ...
  /// Counts all trees that can be built with the leaf set gamma, without actually building these trees.
